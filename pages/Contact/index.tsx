            ...
            <div className={styles.wide}>
                <div className={styles.contactCard}>
                    <div className={styles.header_text}>
                        <Image className={styles.locationIcon} src={LocaLogo} height={36} width={36} />
                ...
                <div className={styles.contactCard}>
                    <div className={styles.header_text}>
                        <Image className={styles.locationIcon} src={PhoneCall} height={36} width={36} />
                        <h2 className={styles.titleCard}>
                            Phone
                        </h2>
                    </div>
                ...
                <div className={styles.contactCard}>
                    <div className={styles.header_text}>
                        <Image className={styles.locationIcon} src={Clock} height={36} width={36} />
                        <h2 className={styles.titleCard}>
                            Working Time
                        </h2>
                    </div>
